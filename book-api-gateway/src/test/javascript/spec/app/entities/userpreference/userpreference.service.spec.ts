...
describe('Service Tests', () => {
    ...
    describe('Userpreference Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(UserpreferenceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/userpreferences/' + 123);
            });
            it('should return Userpreference', () => {

                let entity: Userpreference;
                service.find(123).subscribe((_entity: Userpreference) => {
                    entity = _entity;
                });
