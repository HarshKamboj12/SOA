...
import mk.ukim.finki.soa.AuthormicroserviceApp;
...
@SpringBootTest(classes = AuthormicroserviceApp.class)
public class AuthorResourceIntTest {

    private static final String DEFAULT_NAME = "AAAAAAAAAA";
    private static final String UPDATED_NAME = "BBBBBBBBBB";

    private static final Integer DEFAULT_BORN = 1;
    private static final Integer UPDATED_BORN = 2;
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getBorn()).isEqualTo(DEFAULT_BORN);
    ...
    public void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].born").value(hasItem(DEFAULT_BORN)))
    ...
    public void getAuthor() throws Exception {
        ...
        restAuthorMockMvc.perform(get("/api/authors/{id}", author.getId()))
            ...
            .andExpect(jsonPath("$.born").value(DEFAULT_BORN))
    ...
    public void updateAuthor() throws Exception {
        ...
        assertThat(testAuthor.getBorn()).isEqualTo(UPDATED_BORN);
